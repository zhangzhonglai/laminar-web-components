 ...
 *
 * @see
 *   <a href="https://github.com/material-components/material-components-web-components">Component Collection
 *   Documentation</a>
 */
package com.github.zhangzhonglai.laminar.webcomponents.material {
   ...
   * @see
   *   <a
   *   href="https://github.com/material-components/material-components-web-components/tree/master/packages/button">Component
   *   Documentation</a>
   */
  object Button {
    ...
    object slots {
      ...
      /**
       * Default content to display between both icons and after label. NOTE: It is highly recommended to set the label
       * property instead of projecting text as it will also set the aria-label
       *
       * @see
       *   <a
       *   href="https://github.com/material-components/material-components-web-components/tree/master/packages/button">Component
      ...
      /**
       * Icon to show after the label. Overrides trailingIcon property. Use label or the trailingIcon property to set
       * the aria-label.
       *
       * @see
       *   <a
    ...
    object styles {
      ...
      /**
       * Left and right padding of the button label (for outlined buttons the outline width is automatically
       * subtracted).
       *
       * @see
       *   <a
   ...
   * @see
   *   <a
   *   href="https://github.com/material-components/material-components-web-components/tree/master/packages/checkbox">Component
   *   Documentation</a>
   */
  object Checkbox {
    ...
    trait RawElement extends js.Object {
      ...
      /**
       * When a checkbox is the parent of a set of child checkboxes, the *indeterminate* state is used on the parent to
      ...
      /**
       * When `true`, the checkbox remove padding for touchscreens and increase density. Note, the checkbox will no
       * longer meet accessibility guidelines for touch.
       *
       * @see
       *   <a
       *   href="https://github.com/material-components/material-components-web-components/tree/master/packages/checkbox">Component
    ...
    /**
     * When `true`, the checkbox remove padding for touchscreens and increase density. Note, the checkbox will no longer
     * meet accessibility guidelines for touch.
     *
     * @see
     *   <a
     *   href="https://github.com/material-components/material-components-web-components/tree/master/packages/checkbox">Component
    ...
    /**
     * Fired when the user modifies the checkbox checked or indeterminate states from an input device interaction. Note
     * that, like native <input>, the change event is not fired when the checked or indeterminate properties are set
     * from JavaScript.
     *
     * @see
     *   <a
   ...
   * @see
   *   <a
   *   href="https://github.com/material-components/material-components-web-components/tree/master/packages/circular-progress">Component
   *   Documentation</a>
   */
  object CircularProgress {
    ...
    trait RawElement extends js.Object {
      ...
      /**
       * Sets the progress indicator's sizing based on density scale. Minimum value is `-8`. Each unit change in density
       * scale corresponds to 4px change in side dimensions. The stroke width adjusts automatically.
       *
       * @see
       *   <a
       *   href="https://github.com/material-components/material-components-web-components/tree/master/packages/circular-progress">Component
      ...
      /**
       * Sets the progress indicator to the closed state. Sets content opacity to 0. Typically should be set to true
    ...
    /**
     * Sets the progress indicator to the closed state. Sets content opacity to 0. Typically should be set to true when
   ...
   * @see
   *   <a
   *   href="https://github.com/material-components/material-components-web-components/tree/master/packages/circular-progress-four-color">Component
   *   Documentation</a>
   */
   ...
   * @see
   *   <a
   *   href="https://github.com/material-components/material-components-web-components/tree/master/packages/dialog">Component
   *   Documentation</a>
   */
  object Dialog {
    ...
    trait RawElement extends js.Object {
      ...
      /**
       * _Default: 'close'_ – Action to be emitted with the `closing` and `closed` events when the dialog closes because
       * the scrim was clicked (see [actions section](#actions)).
       *
       * @see
       *   <a
       *   href="https://github.com/material-components/material-components-web-components/tree/master/packages/dialog">Component
      ...
      /**
       * _Default: 'close'_ – Action to be emitted with the `closing` and `closed` events when the dialog closes because
       * the excape key was pressed (see [actions section](#actions)).
       *
       * @see
       *   <a
       *   href="https://github.com/material-components/material-components-web-components/tree/master/packages/dialog">Component
      ...
      /**
       * _Default: 'close'_ – Action to be emitted with the `closing` and `closed` events when `<mwc-dialog>.open` is
       * toggled (see [actions section](#actions)).
       *
       * @see
       *   <a
       *   href="https://github.com/material-components/material-components-web-components/tree/master/packages/dialog">Component
      ...
      /**
       * _Default: 'dialogAction'_ – Attribute to read in light dom of dialog for closing action value (see [actions
       * section](#actions)).
       *
       * @see
       *   <a
      ...
      /**
       * Forces dialog to relayout (animation frame time). May be required if dialog size is incorrect or if stacked
       * layout has not been triggered correctly.
       *
       * @see
       *   <a
       *   href="https://github.com/material-components/material-components-web-components/tree/master/packages/dialog">Component
    ...
    object slots {
      ...
      /**
       * A focusable and clickable target. Typically a button such as <mwc-button>. Placed on the bottom right of the
       * dialog (LTR) and above the secondary action when stacked. Automatically clicked when Enter key is pressed in
       * the dialog.
       *
       * @see
       *   <a
      ...
      /**
       * A focusable and clickable target. Typically a button such as <mwc-button>. Placed immediately to the left of
       * the primaryAction (LTR) or below when stacked.
       *
       * @see
       *   <a
       *   href="https://github.com/material-components/material-components-web-components/tree/master/packages/dialog">Component
    ...
    /**
     * Fired when the dialog is is beginning to close. Detail is the action that closed the dialog (see [actions
     * section](#actions)).
     *
     * @see
     *   <a
    ...
    /**
     * Fired once the dialog is finished closing (after animation). Detail is the action that closed the dialog (see
    ...
    object styles {
      ...
      /**
       * Color applied to the projected content. (**Note:** it may also be possible to style the content via the light
       * DOM since it is not encapsulated in a shadow root).
       *
       * @see
       *   <a
       *   href="https://github.com/material-components/material-components-web-components/tree/master/packages/dialog">Component
      ...
      /**
       * max-width of the dialog surface. (**Note:** if max-width is < `560px`, there is a visual jank bug that will
       * occur causing the max width to be `560px` when the window is sized to <= than `560px`).
       *
       * @see
       *   <a
       *   href="https://github.com/material-components/material-components-web-components/tree/master/packages/dialog">Component
   ...
   * @see
   *   <a
   *   href="https://github.com/material-components/material-components-web-components/tree/master/packages/drawer">Component
   *   Documentation</a>
   */
  object Drawer {
    ...
    trait RawElement extends js.Object {
      ...
      /**
       * When set to `'dismissible'`, overlays the drawer on the content. When set to `'modal'`, also adds a scrim when
       * the drawer is open. When set to empty string, it is inlined with the page and displaces app content.
       *
       * @see
       *   <a
       *   href="https://github.com/material-components/material-components-web-components/tree/master/packages/drawer">Component
   ...
   * @see
   *   <a
   *   href="https://github.com/material-components/material-components-web-components/tree/master/packages/fab">Component
   *   Documentation</a>
   */
  object Fab {
   ...
   * mwc-formfield
   *
   * A form field is a text caption for MWC input elements including <mwc-checkbox>, <mwc-radio>, and <mwc-switch>. It
   * is equivalent to the native <label> element in that it forwards user interaction events to the input element. For
   * example, tapping on the label causes the associated input element to toggle and focus.
   *
   * {@literal @material/mwc-formfield@0.18.0}
   *
   * @see
   *   <a
   *   href="https://github.com/material-components/material-components-web-components/tree/master/packages/formfield">Component
   *   Documentation</a>
   */
  object Formfield {
   ...
   *
   * Toggle buttons can be used to group related options. To emphasize groups of related toggle buttons, a group should
   ...
   * @see
   *   <a
   *   href="https://github.com/material-components/material-components-web-components/tree/master/packages/icon-button-toggle">Component
   *   Documentation</a>
   */
   ...
   * @see
   *   <a
   *   href="https://github.com/material-components/material-components-web-components/tree/master/packages/icon-button">Component
   *   Documentation</a>
   */
  object IconButton {
   ...
   * mwc-icon
   *
   * Icon displays an icon with a chosen name from the [Material Icons](https://material.io/resources/icons/) font, or
   * from any font that supports *ligatures*.
   *
   * {@literal @material/mwc-icon@0.18.0}
   *
   * @see
   *   <a
   *   href="https://github.com/material-components/material-components-web-components/tree/master/packages/icon">Component
   *   Documentation</a>
   */
  object Icon {
  ...
  object LinearProgress {
    ...
    trait RawElement extends js.Object {
      ...
      /**
       * Sets the buffer progress bar's value. Value should be between [0, 1]. Setting this value to be less than 1 will
       * reveal moving, buffering dots.
       *
       * @see
       *   <a
       *   href="https://github.com/material-components/material-components-web-components/tree/master/packages/linear-progress">Component
      ...
      /**
       * Sets the progress indicator to the closed state. Sets content opactiy to 0. Typically should be set to true
       * when loading has finished.
       *
       * @see
       *   <a
    ...
    /**
     * Sets the progress indicator to the closed state. Sets content opactiy to 0. Typically should be set to true when
     * loading has finished.
     *
     * @see
     *   <a
    ...
    object styles {
      ...
      /**
       * Sets the color of the buffer progress bar.<br> **NOTE:** to change the color of the buffering dots, you must do
       * so in the image of `--mdc-linear-progress-buffering-dots-image`.
       *
       * @see
       *   <a
       *   href="https://github.com/material-components/material-components-web-components/tree/master/packages/linear-progress">Component
   ...
   * mwc-radio
   *
   * Radio buttons allow the user to select one option from a set. Use radio buttons when the user needs to see all
   * available options.
   *
   ...
   * @see
   *   <a
   *   href="https://github.com/material-components/material-components-web-components/tree/master/packages/radio">Component
   *   Documentation</a>
   */
  object Radio {
    ...
    trait RawElement extends js.Object {
      ...
      /**
       * Whether this radio button is the currently-selected one in its group. Maps to the native
       * [`checked`](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/input/radio#checked) attribute.
       *
       * @see
       *   <a
       *   href="https://github.com/material-components/material-components-web-components/tree/master/packages/radio">Component
      ...
      /**
       * If `true`, this radio button cannot be selected or de-selected. Maps to the native
       * [`disabled`](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/input#disabled) attribute.
       *
       * @see
       *   <a
       *   href="https://github.com/material-components/material-components-web-components/tree/master/packages/radio">Component
      ...
      /**
       * Name of the input for form submission, and identifier for the selection group. Only one radio button can be
       * checked for a given selection group. Maps to the native
       * [`name`](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/input#name) attribute.
       *
       * @see
       *   <a
       *   href="https://github.com/material-components/material-components-web-components/tree/master/packages/radio">Component
       ...
       * [`value`](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/input/radio#value) attribute.
       *
       * @see
       *   <a
       *   href="https://github.com/material-components/material-components-web-components/tree/master/packages/radio">Component
      ...
      /**
       * If `true`, this radio button will use a global, document-level scope for its selection group rather than its
       * local shadow root.
       *
       * @see
       *   <a
    ...
    /**
     * Fired when the user modifies the radio checked state from an input device interaction on this radio. Note that,
     * like native <input>, the change event is not fired when the checked property is set from JavaScript, nor is it
     * fired when another radio in the same group becomes checked.
     *
     * @see
     *   <a
     *   href="https://github.com/material-components/material-components-web-components/tree/master/packages/radio">Component
   ...
   * @see
   *   <a
   *   href="https://github.com/material-components/material-components-web-components/tree/master/packages/slider">Component
   *   Documentation</a>
   */
  object Slider {
    ...
    trait RawElement extends js.Object {
      ...
      /**
       * When defined, the slider will quantize (round to the nearest multiple) all values to match that step value,
       * except for the minimum and maximum values, which can always be set. When 0, quantization is disabled.<br>
       * **NOTE:** Throws when <0.
       *
       * @see
       *   <a
      ...
      /**
       * Shows the thumb pin on a discrete slider.<br> **NOTE:** Numbers displayed inside the slider will be rounded to
       ...
       * itself or any of its parent elements change programmatically (it is called automatically on resize and on
    ...
    /**
     * Shows the thumb pin on a discrete slider.<br> **NOTE:** Numbers displayed inside the slider will be rounded to at
    ...
    /**
     * Fired when the value changes due to user input. Similar to the input event of the native <input type="range">
     * element, the input event will not fire when value is modified via JavaScript.
     *
     * @see
     *   <a
     *   href="https://github.com/material-components/material-components-web-components/tree/master/packages/slider">Component
    ...
    /**
     * Fired when the value changes and the user has finished interacting with the slider. Similar to the change event
     * of the native <input type="range"> element, the change event will not fire when value is modified via JavaScript.
     *
     * @see
     *   <a
     *   href="https://github.com/material-components/material-components-web-components/tree/master/packages/slider">Component
    ...
    object styles {
      ...
      /**
       * Sets the color of the circle around the knob on the disabled slider to make it seem cut-out. May be necessary
       * when placing a disabled slider on a different-colored background.
       *
       * @see
       *   <a
       *   href="https://github.com/material-components/material-components-web-components/tree/master/packages/slider">Component
   ...
   * @see
   *   <a
   *   href="https://github.com/material-components/material-components-web-components/tree/master/packages/snackbar">Component
   *   Documentation</a>
   */
  object Snackbar {
    ...
    trait RawElement extends js.Object {
      ...
      /**
       * Automatic dismiss timeout in milliseconds. Value must be between `4000` and `10000` (or `-1` to disable the
       * timeout completely) or an error will be thrown. Defaults to `5000` (5 seconds).
       *
       * @see
       *   <a
       *   href="https://github.com/material-components/material-components-web-components/tree/master/packages/snackbar">Component
    ...
    /**
     * Indicates when the snackbar begins its closing animation. reason contains the reason why the snackbar closed
     * ('dismiss', 'action', or a custom string via the close method).
     *
     * @see
     *   <a
     *   href="https://github.com/material-components/material-components-web-components/tree/master/packages/snackbar">Component
    ...
    /**
     * Indicates when the snackbar finishes its closing animation. reason contains the reason why the snackbar closed
     * ('dismiss', 'action', or a custom string via the close method).
     *
     * @see
     *   <a
   ...
   * @see
   *   <a
   *   href="https://github.com/material-components/material-components-web-components/tree/master/packages/switch">Component
   *   Documentation</a>
   */
  object Switch {
    ...
    /**
     * Fired when the user modifies the switch checked state from an input device interaction. Note that, like native
     * <input>, the change event is not fired when the checked property is set from JavaScript.
     *
     * @see
     *   <a
     *   href="https://github.com/material-components/material-components-web-components/tree/master/packages/switch">Component
  ...
  object TabBar {
     ...
     * @see
     *   <a
     *   href="https://github.com/material-components/material-components-web-components/tree/master/packages/tab">Component
     *   Documentation</a>
     */
    object Tab {
      ...
      /**
       * Emitted when the Tab is interacted with, regardless of its active state. Used by parent components to know
   ...
   * @see
   *   <a
   *   href="https://github.com/material-components/material-components-web-components/tree/master/packages/list">Component
   *   Documentation</a>
   */
  object List {
    ...
    trait RawElement extends js.Object {
      ...
      /**
       * When `true`, enables selection of multiple items. This will result in `index` being of type `Set<number>` and
       * selected returning `ListItemBase[]`.
       *
       * @see
       *   <a
       *   href="https://github.com/material-components/material-components-web-components/tree/master/packages/list">Component
      ...
      /**
       * When `true`, pressing `up` on the keyboard when focused on the first item will focus the last item and `down`
       * when focused on the last item will focus the first item.
       *
       * @see
       *   <a
       *   href="https://github.com/material-components/material-components-web-components/tree/master/packages/list">Component
      ...
      /**
       * All list items that are available for selection. Eligible items have the `[mwc-list-item]` attribute which
       * `ListItemBase` applies automatically.
       *
       * @see
       *   <a
       *   href="https://github.com/material-components/material-components-web-components/tree/master/packages/list">Component
      ...
      /**
       * Currently-selected list item(s). When `multi` is `true`, `selected` is of type `ListItemBase[]` and when
       * `false`, `selected` is of type `ListItemBase`. `selected` is `null` when no item is selected.
       *
       * @see
       *   <a
       *   href="https://github.com/material-components/material-components-web-components/tree/master/packages/list">Component
      ...
      /**
       * Index / indices of selected item(s). When `multi` is `true`, `index` is of type `number` and when `false`,
       * `index` is of type `Set<number>`. Unset indicies are `-1` and empty `Set<number>` for single and multi
       ...
       * selectability of an element is dynamically changed. e.g. `[mwc-list-item]` attribute is removed from a list
       * item or `noninteractive` is dynamically set on a list item.
       *
       * @see
       *   <a
       *   href="https://github.com/material-components/material-components-web-components/tree/master/packages/list">Component
    ...
    /**
     * Fired when a selection has been made. index is the selected index (will be of type Set<number> if multi and
     * number if single), and diff (of type IndexDiff**) represents the diff of added and removed indices from previous
     * selection.
     *
     * @see
     *   <a
    ...
    object ListItem {
      ...
      object slots {
        ...
        /**
         * Primary text to display in the list item. Note, text must be wrapped in an inline node to be styled for
         * disabled variant.
         *
         * @see
         *   <a
      ...
      object styles {
        ...
        /**
         * Line height of the graphic and width & height of the slotted parent wrapper. 24px when graphic is "icon".
         * 40px when graphic is "avatar". 56px when graphic is "medium", and "large".
         *
         * @see
         *   <a
         *   href="https://github.com/material-components/material-components-web-components/tree/master/packages/list">Component
        ...
        /**
         * Margin between the text and graphic. 16px when graphic is "avatar", "medium", "large", and "control". 32px
         * when graphic is "icon".
         *
         * @see
         *   <a
         *   href="https://github.com/material-components/material-components-web-components/tree/master/packages/list">Component
   ...
   * @see
   *   <a
   *   href="https://github.com/material-components/material-components-web-components/tree/master/packages/menu">Component
   *   Documentation</a>
   */
  object Menu {
    ...
    trait RawElement extends js.Object {
      ...
      /**
       * Determines from which element the floating menu should calculate sizing and position offsets. In the default
       * case, both mwc-menu and the anchor should share a parent with position:relative. Changing anchor typically
       * requires absolute or fixed.
       *
       * @see
       *   <a
       *   href="https://github.com/material-components/material-components-web-components/tree/master/packages/menu">Component
      ...
      /**
       * Horizontal corner of the menu from which the menu should position itself. **NOTE:** Only horizontal corners are
       * supported.
       *
       * @see
       *   <a
      ...
      /**
       * Makes the menu's position absolute which will be relative to whichever ancestor has position:relative. Setting
       * x and y will modify the menu's left and top. Setting anchor will attempt to position the menu to the anchor.
       *
       * @see
       *   <a
       *   href="https://github.com/material-components/material-components-web-components/tree/master/packages/menu">Component
      ...
      /**
       * Makes the menu's position fixed which will be relative to the window. Setting x and y will modify the menu's
       * left and top. Setting anchor will attempt to position the menu to the anchor's immediate position before
       * opening.
       *
       * @see
       *   <a
      ...
      /**
       * Sets horizontal position when absolute or fixed. When given an anchor, sets horizontal position relative to
       * anchor at given corner. Requires y not to be null.
       *
       * @see
       *   <a
       *   href="https://github.com/material-components/material-components-web-components/tree/master/packages/menu">Component
      ...
      /**
       * Sets vertical position when absolute or fixed. When given an anchor, sets vertical position relative to anchor
       * at given corner. Requires x not to be null.
       *
       * @see
       *   <a
       *   href="https://github.com/material-components/material-components-web-components/tree/master/packages/menu">Component
      ...
      /**
       * Forces a menu group to have a selected item by preventing deselection of menu items in menu groups via user
       * interaction.
       *
       * @see
       *   <a
      ...
      /**
       * Proxies to
       * [mwc-list's](https://github.com/material-components/material-components-web-components/tree/master/packages/list#mwc-list-1)
       * wrapFocus property.
       *
       * @see
       *   <a
      ...
      /**
       * Resets tabindex on all items and will update `items` model if provided true. It may be required to call layout
       * if selectability of an element is dynamically changed. e.g. `[mwc-list-item]` attribute is removed from a list
       * item or `noninteractive` is dynamically set on a list item.
       *
       * @see
       *   <a
    ...
    /**
     * Makes the menu's position absolute which will be relative to whichever ancestor has position:relative. Setting x
     * and y will modify the menu's left and top. Setting anchor will attempt to position the menu to the anchor.
     *
     * @see
     *   <a
     *   href="https://github.com/material-components/material-components-web-components/tree/master/packages/menu">Component
    ...
    /**
     * Makes the menu's position fixed which will be relative to the window. Setting x and y will modify the menu's left
     * and top. Setting anchor will attempt to position the menu to the anchor's immediate position before opening.
     *
     * @see
     *   <a
     *   href="https://github.com/material-components/material-components-web-components/tree/master/packages/menu">Component
    ...
    /**
     * Sets vertical position when absolute or fixed. When given an anchor, sets vertical position relative to anchor at
     * given corner. Requires x not to be null.
     *
     * @see
     *   <a
     *   href="https://github.com/material-components/material-components-web-components/tree/master/packages/menu">Component
    ...
    /**
     * Fired when a selection has been made. `index` is the selected index (will be of type `Set<number>` if multi and
     * `number` if single), and `diff` (of type `IndexDiff`**) represents the diff of added and removed indices from
     * previous selection.
     *
     * @see
     *   <a
   ...
   * @see
   *   <a
   *   href="https://github.com/material-components/material-components-web-components/tree/master/packages/textfield">Component
   *   Documentation</a>
   */
  object Textfield {
    ...
    trait RawElement extends js.Object {
      ...
      /**
       * [HTMLInputElement.prototype.pattern](https://developer.mozilla.org/en-US/docs/Web/Guide/HTML/HTML5/Constraint_validation#Validation-related_attributes)
      ...
      /**
       * [HTMLInputElement.prototype.min](https://developer.mozilla.org/en-US/docs/Web/Guide/HTML/HTML5/Constraint_validation#Validation-related_attributes)
       * (empty string will unset attribute)
       *
       * @see
       *   <a
      ...
      /**
       * [HTMLInputElement.prototype.max](https://developer.mozilla.org/en-US/docs/Web/Guide/HTML/HTML5/Constraint_validation#Validation-related_attributes)
       * (empty string will unset attribute)
       *
       * @see
       *   <a
      ...
      /**
       * [HTMLInputElement.prototype.Size](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/input#htmlattrdefsize)
      ...
      /**
       * [HTMLInputElement.prototype.Step](https://developer.mozilla.org/en-US/docs/Web/Guide/HTML/HTML5/Constraint_validation#Validation-related_attributes)
       * (null will unset attribute)
       *
       * @see
       *   <a
      ...
      /**
       * Returns true if the textfield passes validity checks. Returns false and fires an invalid event on the textfield
       * otherwise. NOTE: When accessing any property or function that checks validity at textfield initial boot up, you
       * may have to await <mwc-textfield>.updateComplete.
       *
       * @see
       *   <a
       *   href="https://github.com/material-components/material-components-web-components/tree/master/packages/textfield">Component
      ...
      /**
       * Sets a custom validity message (also overwrites validationMessage). If this message is not the empty string,
      ...
      /**
       * Re-calculate layout. If a textfield is styled with display:none before it is first rendered, and it has a label
       * that is floating, then you must call layout() the first time you remove display:none, or else the notch
    ...
    object styles {
      ...
      /**
       * Color of the input text, the floating label, helper text, char counter, and placeholder of a disabled
       * textfield.
       *
       * @see
       *   <a
   ...
   * @see
   *   <a
   *   href="https://github.com/material-components/material-components-web-components/tree/master/packages/textarea">Component
   *   Documentation</a>
   */
  object Textarea {
    ...
    trait RawElement extends js.Object {
      ...
      /**
       * **Note: requires maxLength to be set.** Display character counter with max length. Textareas may display an
       * "external" or "internal" charCounter. When true, textareas display an external character counter by default.
       *
       * @see
       *   <a
       *   href="https://github.com/material-components/material-components-web-components/tree/master/packages/textarea">Component
      ...
      /**
       * Returns true if the textarea passes validity checks. Returns false and fires an invalid event on the textarea
       * otherwise.
       *
       * @see
       *   <a
      ...
      /**
       * Re-calculate layout. If a textarea is styled with display:none before it is first rendered, and it has a label
       * that is floating, then you must call layout() the first time you remove display:none, or else the notch
       * surrounding the label will not render correctly.
       *
       * @see
   ...
   * @see
   *   <a
   *   href="https://github.com/material-components/material-components-web-components/tree/master/packages/select">Component
   *   Documentation</a>
   */
  object Select {
    ...
    trait RawElement extends js.Object {
      ...
      /**
       * The select control's value determined by the value property of the currently selected list item. Setting value
       * will attempt to select a list-item with the same value. If one does not match, it will set itself to "" and the
       * index to -1. Setting value before the list item is attached will not select the item.
       *
       * @see
       *   <a
       *   href="https://github.com/material-components/material-components-web-components/tree/master/packages/select">Component
       ...
       * [mwc-icon](https://github.com/material-components/material-components-web-components/tree/master/packages/icon).
       * _Note_: for proper list spacing, each list item must have graphic="icon" or graphic="avatar" to be set.
       *
       * @see
       *   <a
       *   href="https://github.com/material-components/material-components-web-components/tree/master/packages/select">Component
      ...
      /**
       * Callback called before each validation check. See the [mwc-textfield's validation
       * section](https://github.com/material-components/material-components-web-components/tree/master/packages/textfield#validation)
       * for more details.
       *
       * @see
       *   <a
      ...
      /**
       * Returns `true` if the select passes validity checks. Returns `false` and fires an
       * [`invalid`](https://developer.mozilla.org/en-US/docs/Web/API/HTMLInputElement/invalid_event) event on the
       * select otherwise. <br>**NOTE:** When accessing any property or function that checks validity at select initial
       * boot up, you may have to await `<mwc-select>.updateComplete`.
       *
       * @see
       *   <a
       *   href="https://github.com/material-components/material-components-web-components/tree/master/packages/select">Component
       ...
       * Resets tabindex on all items and will update `items` model if provided true. It may be required to call layout
       * if selectability of an element is dynamically changed. e.g. `[mwc-list-item]` attribute is removed from a list
       * item or `noninteractive` is dynamically set on a list item. Also re-calculates layout. If a select is styled
       * with `display:none` before it is first rendered, and it has a label that is floating, then you must call
       * `layout()` the first time you remove `display:none`, or else the notch surrounding the label will not render
       * correctly.
       *
       * @see
       *   <a
   ...
   *
   * Fixed Top App Bars are a container for items such as application title, navigation icon, and action items that are
   * always visible.
   *
   ...
   * @see
   *   <a
   *   href="https://github.com/material-components/material-components-web-components/tree/master/packages/top-app-bar-fixed">Component
   *   Documentation</a>
   */
   ...
   * @see
   *   <a
   *   href="https://github.com/material-components/material-components-web-components/tree/master/packages/top-app-bar">Component
   *   Documentation</a>
   */
  object TopAppBar {
